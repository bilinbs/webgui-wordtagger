...
<div class="section-content">
				...
				<h1 class="section-header pull-left"><span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> മലയാളം ശബ്ദഭേദങ്ങൾ</span> 
				<br/>
				<span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Hybrid Parts of Speech Tagger</span></h1>
</div>
<br/>
